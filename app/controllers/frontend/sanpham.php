				...
				if($this->form_validation->run() == TRUE){
					...
					<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" style="border-top:#00918c 10px solid;border-bottom:#00918c 10px solid">
						<tbody>
							<tr>
								<td>
									<h1 style="font-family:tahoma;color:#ffffff;font-size:24px">Xác nhận thông tin đơn hàng số #NGOCNGA'.$donhang['id'].'</h1> </td>
							</tr>
						</tbody>
					</table>
					</td>
					...
					<table width="700" border="0" cellspacing="0" cellpadding="3" align="center" style="border-bottom:20px solid #ffffff;background:#fff;padding:15px">
						<tbody>
							...
							<tr>
								<td valign="top">
									<h1 style="font-family:tahoma;margin:0;color:#000000;font-size:20px;border-top:1px solid #efefef;padding-bottom:15px;padding-top:15px">Thông tin chi tiết số #NGOCNGA'.$donhang['id'].'</h1> </td>
							</tr>
							<tr>
								<td>
					...
					$mail->Subject = '['.$this->system['meta_title'].'] Thông tin báo giá số #NGOCNGA'.$donhang['id'];
