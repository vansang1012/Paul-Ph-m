...
class Articles extends MY_Controller{
	...
	public function additem(){
		...
		if($this->input->post('add')){
			...
			$post_data = $this->lib_post->allows($post_data, array('title', 'slug', 'image', 'parentid', 'description','created', 'content', 'tags', 'publish', 'meta_title', 'meta_keyword', 'meta_description'));
